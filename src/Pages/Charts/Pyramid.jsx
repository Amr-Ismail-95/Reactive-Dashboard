...
const Pyramid = () => {
  return (
    <div className="m-4 md:m-10 mt-24  p-10 bg-white dark:bg-secondary-dark-bg rounded-3xl">
      <Header category='Area' title='Food Comparison Chart'/>
      <div className='w-full'>
        ...
        tooltip={{enable: true}}
        >
        <Inject services={[AccumulationLegend, PyramidSeries, AccumulationSelection, AccumulationDataLabel, AccumulationTooltip]} />
