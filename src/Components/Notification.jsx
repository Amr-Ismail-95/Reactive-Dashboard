...
const Notification = () => {
  const { currentColor,noti,setNoti } = useStateContext();
  ...
  return (
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      {noti && (<><div className="flex justify-between items-center">
        ...
        <Button text={<MdOutlineCancel />} customFunc={handleCloseNotifications} color="rgb(153, 171, 180)" bgHoverColor="light-gray" size="2xl" borderRadius="50%" />
      </div>
      <div className="mt-5 ">
